all: main
CC = clang
override CFLAGS += -std=c2x -o0 -Wconversion -Wno-sign-conversion -Wdouble-promotion -ffunction-sections -flto -march=native -Wpedantic -DTB_LIB_OPTS=1 -DTB_OPT_ATTR_W=32 -DTB_OPT_PRINTF_BUF=16
